...
const lebuffEl = document.getElementById("LebuffMode-input");
const lebuffContainer = document.getElementById("lebuff-settings-container");
const lebuffPushupInputEl = document.getElementById("lebuffPushupCount-input");
...
const setInputValues = (_settings) => {
  ...
  lebuffEl.checked = lebuffMode;
  lebuffPushupInputEl.value = lebuffPushupCount;
  ...
  if (!lebuffMode) {
    lebuffContainer.classList.add("disabled");
  } else {
    lebuffContainer.classList.remove("disabled");
  }
}
...
addCheckboxListener(skipsEl, "skips", (event) => {
  console.log("Clicked lebuff checkbox")
...
addCheckboxListener(lebuffEl, "lebuffMode", (event) => {
  if (!event.target.checked) {
    addClass(lebuffContainer, "disabled");

    lebuffPushupInputEl.disabled = true;
    addClass(lebuffEl, "disabled");

    if (data.lebuffMode) {
      data.lebuffMode = false;
    }
  }
  else {
    lebuffPushupInputEl.disabled = false;
    removeClass(lebuffEl, "disabled");
    removeClass(lebuffContainer, "disabled");
  }
});

addInputListener(lebuffPushupInputEl, "lebuffPushupCount", { min: true, max: true });
addFocusOutListener(lebuffPushupInputEl, "freeSkips");
